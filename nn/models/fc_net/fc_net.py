...
class FC_NET(BaseModel):
	...
	with tf.name_scope("Fully-connected"):
	    ...
	    with tf.variable_scope("Layer1"):
	       	ytmp = fully_connected(Xtmp, num_neurons=50, name='W1', is_training = is_training, use_batch_norm=True, use_drop_out=False, keep_prob = 0.7, activation = 'sigmoid')	
	    with tf.variable_scope("Layer2"):
	    	ytmp = fully_connected(ytmp, num_neurons=25, name='W2', is_training = is_training, use_batch_norm=True, use_drop_out=False, keep_prob = 1.0, activation = 'sigmoid')
	    with tf.variable_scope("Layer3"):
	    	ytmp = fully_connected(ytmp, num_neurons=1, name='W3', is_training = is_training, use_batch_norm=True, use_drop_out=False, keep_prob = 1, activation = 'None')
