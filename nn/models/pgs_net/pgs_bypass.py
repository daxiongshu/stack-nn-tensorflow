...
class PGS_BYPASS_NET(BaseModel):
    # Per-group-softmax net
    def build(self):
	print "build PGS_BYPASS_NET" 
	params = self.params
	...
	ytmp = ytmp + fully_connected(Xtmp, num_neurons=1, name='W4', is_training = is_training, use_batch_norm=True, use_drop_out=False, keep_prob = 0.7, activation = 'sigmoid', default_batch = params.default_batch)
